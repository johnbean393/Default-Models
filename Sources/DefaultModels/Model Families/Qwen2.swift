...
public class Qwen2: ModelSet {
	...
	private static let qwen_2pt5_14b: HuggingFaceModel = HuggingFaceModel(
		params: 14,
		urlString: "https://huggingface.co/bartowski/Qwen2.5-14B-Instruct-GGUF/resolve/main/Qwen2.5-14B-Instruct-IQ4_XS.gguf?download=true",
		minRam: 24,
		minGpuTflops: 16.2,
		mmluScore: 79.7
	)
	...
	private static let qwen_2pt5_7b_coder: HuggingFaceModel = HuggingFaceModel(
		params: 7,
		urlString: "https://huggingface.co/bartowski/Qwen2.5.1-Coder-7B-Instruct-GGUF/resolve/main/Qwen2.5.1-Coder-7B-Instruct-Q8_0.gguf?download=true",
		minRam: 16,
		minGpuTflops: 6.7,
		mmluScore: 70.3,
	...
	private static let qwen_2pt5_14b_coder: HuggingFaceModel = HuggingFaceModel(
		params: 14,
		urlString: "https://huggingface.co/bartowski/Qwen2.5-Coder-14B-Instruct-GGUF/resolve/main/Qwen2.5-Coder-14B-Instruct-IQ4_XS.gguf?download=true",
		minRam: 24,
		minGpuTflops: 16.2,
		mmluScore: 79.7,
		specializations: [.coding]
	...
	private static let qwen_2pt5_32b_coder: HuggingFaceModel = HuggingFaceModel(
		params: 32,
		urlString: "https://huggingface.co/bartowski/Qwen2.5-Coder-32B-Instruct-GGUF/resolve/main/Qwen2.5-Coder-32B-Instruct-IQ4_XS.gguf?download=true",
		minRam: 36,
		minGpuTflops: 16.2,
		mmluScore: 83.3,
		specializations: [.coding]
	...
	private static let qwen_2pt5_7b_math: HuggingFaceModel = HuggingFaceModel(
		params: 7,
		urlString: "https://huggingface.co/bartowski/Qwen2.5-Math-7B-Instruct-GGUF/resolve/main/Qwen2.5-Math-7B-Instruct-Q8_0.gguf?download=true",
		minRam: 16,
		minGpuTflops: 6.7,
		mmluScore: 70.3,
	...
	private static let qwq_32b_preview: HuggingFaceModel = HuggingFaceModel(
		params: 32,
		urlString: "https://huggingface.co/bartowski/QwQ-32B-Preview-GGUF/resolve/main/QwQ-32B-Preview-IQ4_XS.gguf?download=true",
		minRam: 36,
		minGpuTflops: 16.2,
		mmluScore: 83.3,
