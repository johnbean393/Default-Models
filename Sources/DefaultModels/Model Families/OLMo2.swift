...
public class OLMo2: ModelSet {
	...
	private static let olmo_2_7b: HuggingFaceModel = HuggingFaceModel(
		params: 7,
		urlString: "https://huggingface.co/bartowski/OLMo-2-1124-7B-Instruct-GGUF/resolve/main/OLMo-2-1124-7B-Instruct-Q8_0.gguf?download=true",
		minRam: 16,
		minGpuTflops: 6.7,
		mmluScore: 63.7,
	...
	private static let olmo_2_13b: HuggingFaceModel = HuggingFaceModel(
		params: 14,
		urlString: "https://huggingface.co/bartowski/OLMo-2-1124-13B-Instruct-GGUF/resolve/main/OLMo-2-1124-13B-Instruct-IQ4_XS.gguf?download=true",
		minRam: 24,
		minGpuTflops: 13.6,
		mmluScore: 67.5,
		specializations: [.fullyOpenSource]
